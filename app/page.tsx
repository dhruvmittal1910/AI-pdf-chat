...
export default function Home() {
  return (
    // <div className="">
    <div className=" flex-1  overflow-scroll p-2 lg:p-5 bg-gradient-to-bl from-white to-indigo-900">
      <div className="bg-white py-24 sm:py-32 rounded-md drop-shadow-xl ">
        <div className=" flex flex-col justify-center items-center mx-auto max-w-6xl px-6 lg:px-8">
          <div className="max-auto max-w-2xl sm:text-center">
            <h2 className="text-base font-semibold leading-3 text-indigo-900">
              Your Interactive Document Companion
            </h2>
            <p className="mt-2 text-2xl font-bold tracking-right text-gray-800 sm:text-5xl">
              Transform PDF into INTERACTIVE CONVERSATIONS
            </p>
            {/* description */}
          ...
          <Button asChild className="mt-10">
            <Link href="/dashboard">LETS BEGIN</Link>
          </Button>
        </div>
        ...
        <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
          <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-gray-600 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-9 shadow-lg rounded-lg">
                <dt className="inline font-semibold text-gray-900">
                  <feature.icon
                    aria-hidden="true"
                    className="absolute left-1 top-1 h-5 w-5 text-indigo-800"
                  />
                </dt>
